...
module.exports = function (app) {
    ...
    app.post("/photo/upload/:id", async (req, res) => {
        ...
        // facebook id from url paramater
        const fb_ID = req.params.id
        // upload params define what bucket this goes into
        // the key as a reference for the file
        // and the body, which we will use the buff for
        const uploadParams = { 
            Bucket: process.env.BUCKET_NAME, 
            Key: `${fb_ID}.${req.body.ext}`,
            Body: buff
        }
        // upload the image
